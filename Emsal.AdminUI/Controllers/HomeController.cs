    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                BaseOutput enumcat = srv.WS_GetEnumCategorysByName(baseInput, "edv", out modelProductCatalog.EnumCategory);
                if (modelProductCatalog.EnumCategory == null)
                    modelProductCatalog.EnumCategory = new tblEnumCategory();

                BaseOutput enumval = srv.WS_GetEnumValuesByEnumCategoryId(baseInput, modelProductCatalog.EnumCategory.Id, true, out modelProductCatalog.EnumValueArray);
                modelProductCatalog.EnumValueEDVList = modelProductCatalog.EnumValueArray.ToList();
            ...
            )
        {
            try
            {
                ...
                modelProductCatalog.ProductCatalog.edvStatus = edvStatus;
                modelProductCatalog.ProductCatalog.edvStatusSpecified = true;
