    ...
    public class PotentialProductionController : Controller
    {
        ...
        public ActionResult Index(int? page, string statusEV = null, long productId = -1, string userInfo = null)
        {
            try
            {
                ...
                modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1 = new GetDemandProductionDetailistForEValueIdSearch1();

                modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1.state_eV_Id = modelPotentialProduction.EnumValue.Id;
                modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1.page = pageNumber;
                modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1.pageSize = pageSize;
                modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1.prodcutID = sproductId;
                modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1.Name = suserInfo;

                BaseOutput gpp = srv.WS_GetPotensialProductionDetailistForEValueId_OP(baseInput, modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1, out modelPotentialProduction.ProductionDetailArray);
                ...
                BaseOutput gppc = srv.WS_GetPotensialProductionDetailistForEValueId_OPC(baseInput, modelPotentialProduction.GetDemandProductionDetailistForEValueIdSearch1, out modelPotentialProduction.itemCount, out modelPotentialProduction.itemCountB);
