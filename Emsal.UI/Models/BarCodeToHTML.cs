...
namespace WebBarCodec.Core
{
    public class BarCodeToHTML
    {
        public static string get39(string s, int width, int height)
        {
            ...
            return "<div style=\"background:#FFFFFF;padding:5px;font-size:" + (width * 5) + "px;font-family:'Arial';\">" + result_html + "</div>";
        }
        ...
        public static string getEAN13(string s, int width, int height)
        {
            ...
            return "<div style=\"background:#FFFFFF;padding:0px;font-size:" + (width * 5) + "px;font-family:'Arial';\">" + result_html + "</div>";
        }
