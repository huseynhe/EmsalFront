...
{
    //[EmsalAuthorization(AccessLevel = "producerPerson")]
    ...
    public class ProfileController : Controller
    {
        ...
        public ActionResult Index(long?userId)
        {
            ...
            BaseOutput person = srv.WS_GetPersonByUserId(baseInput, (long)userId, true, out modelPotentialProduction.Person);
            //////
        ...
        public ActionResult Index(PotentialProductionViewModel model, FormCollection collection)
        {
            ...
            else
            {
                ...
                BaseOutput envalyd = srv.WS_GetEnumValueByName(baseInput, "Tesdiqlenmeyen", out modelPotentialProduction.EnumValue);
        ...
        public ActionResult SelectedProducts(bool pdf = false)
        {
            ...
            BaseOutput gpd = srv.WS_GetPotensialProductionDetailistForUser(baseInput, userId, true, out modelPotentialProduction.ProductionDetailArray);
            ...
            modelPotentialProduction.userId = userId;
